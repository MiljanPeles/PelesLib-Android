package com.miljanpeles.lib.bitmap.compressor;
...
/**
 * CREDITS     : https://github.com/zetbaitsu
 *
 * KORISCENJE:
 * compressedImageFile = Compressor.getDefault(this).compressToFile(actualImageFile); // kompresuje u file
 * compressedImageBitmap = Compressor.getDefault(this).compressToBitmap(actualImageFile); // kompresuje file u bitmapt
 *
